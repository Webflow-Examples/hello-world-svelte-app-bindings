...
| `src/sentry.ts`                | Browser init (`@sentry/svelte`, logs + traces)                |
| `src/lib/SentryPinger.svelte`  | Pings the API every 30s; emits a browser-side log per round trip; buttons to trigger test errors |
